...
| [`07/index.html`](07/index.html), [`09/index.html`](09/index.html) | One page per demo. **All the English text lives here**, so it reads instantly — even before (or without) any scripts. |
...
The version appears in **two** places on **each** demo page (`07/` and
`09/`) — change them all, to the same number:
...
Follow the same pattern as `07/` and `09/`:
